    ...
    <section className="page reveal" id="models">
      ...
      <div className="sect-head">
        <div>
          ...
          <p className="lede" style={{ margin: "14px 0 0" }}>
            {t("All inference is routed through LiteLLM on ")}<span className="num" style={{ color: "var(--accent)" }}>10.0.0.10:4000</span>{t(" — OpenAI-compatible API, smart routing, fallbacks, cost & token accounting. Cold models spin up on demand to fit the VRAM budget.")}
          </p>
        </div>
        ...
        <div style={{ padding: 22, display: "grid", gridTemplateColumns: "1.6fr 1fr 1fr 1fr 1fr", gap: 22, alignItems: "center" }}>
          <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
            ...
            <div className="num" style={{ fontSize: 11.5, color: "var(--ink-3)" }}>
              litellm 1.83.10 · Atlas · 10.0.0.10:4000 · OpenAI-compatible /v1/*
            </div>
          </div>
          ...
          <div className="fabric">
            {w > 0 && (
              <svg viewBox={`0 0 ${w} ${H}`}>
                ...
                {/* atlas node */}
                <NodeBlob x={ATL.x} y={ATL.y} label="ATLAS · RTX 4090" sub="10.0.0.10" color="var(--accent)" util={_live.nodes["atlas"].gpu.now} />
                {sparks.map((s) => (
