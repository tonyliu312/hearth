...
(() => {
  ...
  const NODES = [
    { id: "atlas",    name: "Atlas",    ip: "10.0.0.10",  role: "Gateway · Edge",   class: "RTX 4090 host",
    ...
    { id: "spark-01", name: "Spark-01", ip: "10.0.0.21", role: "Inference · A",    class: "DGX Spark",
    ...
    { id: "spark-02", name: "Spark-02", ip: "10.0.0.22", role: "Inference · B",    class: "DGX Spark",
      os: "Ubuntu 24.04 LTS (DGX OS)", kernel: "6.8.0-49", driver: "NVIDIA 560.40", cuda: "12.6",
      gpu: { name: "GB10 Grace-Blackwell", mem: 128, fp16: 250.0, fp4: 1000.0 },
      cpu: { model: "Grace 20-core ARM",   cores: 20, threads: 20 },
      ram: 128, disk: 4096, net: "200 GbE ConnectX-7",
      services: ["vllm","sglang","node-exporter","dcgm"] },
    { id: "spark-03", name: "Spark-03", ip: "10.0.0.23", role: "Inference · C",    class: "DGX Spark",
      os: "Ubuntu 24.04 LTS (DGX OS)", kernel: "6.8.0-49", driver: "NVIDIA 560.40", cuda: "12.6",
      gpu: { name: "GB10 Grace-Blackwell", mem: 128, fp16: 250.0, fp4: 1000.0 },
      cpu: { model: "Grace 20-core ARM",   cores: 20, threads: 20 },
      ram: 128, disk: 4096, net: "200 GbE ConnectX-7",
      services: ["vllm","node-exporter","dcgm"] },
    { id: "spark-04", name: "Spark-04", ip: "10.0.0.24", role: "Inference · D",    class: "DGX Spark",
      os: "Ubuntu 24.04 LTS (DGX OS)", kernel: "6.8.0-49", driver: "NVIDIA 560.40", cuda: "12.6",
      gpu: { name: "GB10 Grace-Blackwell", mem: 128, fp16: 250.0, fp4: 1000.0 },
      cpu: { model: "Grace 20-core ARM",   cores: 20, threads: 20 },
      ram: 128, disk: 4096, net: "200 GbE ConnectX-7",
